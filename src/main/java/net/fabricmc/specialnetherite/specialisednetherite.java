...
public class specialisednetherite implements ModInitializer {
	...
	public static ToolItem OVER_NETHERITE_SWORD = new SwordItem(OverworldNetherite.INSTANCE, 20, -2.4f, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem OVER_NETHERITE_AXE = new OverworldNetherite.OverAxe(OverworldNetherite.INSTANCE, 32, 4, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem NETHER_NETHERITE_SWORD = new SwordItem(NetherNetherite.INSTANCE, 20, -2.4f, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem NETHER_NETHERITE_AXE = new NetherNetherite.NetherAxe(NetherNetherite.INSTANCE, 32, 4, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem END_NETHERITE_SWORD = new SwordItem(EndNetherite.INSTANCE, 20, -2.4f, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem END_NETHERITE_AXE = new EndNetherite.EndAxe(EndNetherite.INSTANCE, 32, 4, new Item.Settings().group(TOOLS).fireproof());
