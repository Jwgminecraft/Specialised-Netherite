...
import static net.fabricmc.loom.configuration.MavenPublication.configure;
...
public class SpecialNetherite implements ModInitializer {
	...
	public static ToolItem OVER_NETHERITE_SWORD = new SwordItem(OverworldNetherite.INSTANCE, -7, -3.4f, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem OVER_NETHERITE_PICKAXE = new OverworldNetherite.OverPickaxe(OverworldNetherite.INSTANCE, -11, -2.8f, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem OVER_NETHERITE_AXE = new OverworldNetherite.OverAxe(OverworldNetherite.INSTANCE, -7, -2, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem OVER_NETHERITE_SHOVEL = new ShovelItem(OverworldNetherite.INSTANCE, -7.5f, 0, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem OVER_NETHERITE_HOE = new OverworldNetherite.OverHoe(OverworldNetherite.INSTANCE, -13, 0, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem NETHER_NETHERITE_SWORD = new SwordItem(NetherNetherite.INSTANCE, -7, -3.4f, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem NETHER_NETHERITE_PICKAXE = new NetherNetherite.NetherPickaxe(NetherNetherite.INSTANCE, -11, -2.8f, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem NETHER_NETHERITE_AXE = new NetherNetherite.NetherAxe(NetherNetherite.INSTANCE, -7, -2, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem NETHER_NETHERITE_SHOVEL = new ShovelItem(NetherNetherite.INSTANCE, -7.5f, 0, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem NETHER_NETHERITE_HOE = new NetherNetherite.NetherHoe(NetherNetherite.INSTANCE, -13, 0, new Item.Settings().group(TOOLS).fireproof());
	...
	public static ToolItem END_NETHERITE_SWORD = new SwordItem(EndNetherite.INSTANCE, -7, -3.4f, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem END_NETHERITE_PICKAXE = new EndNetherite.EndPickaxe(EndNetherite.INSTANCE, -11, -2.8f, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem END_NETHERITE_AXE = new EndNetherite.EndAxe(EndNetherite.INSTANCE, -7, -2, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem END_NETHERITE_SHOVEL = new ShovelItem(EndNetherite.INSTANCE, -7.5f, 0, new Item.Settings().group(TOOLS).fireproof());
	public static ToolItem END_NETHERITE_HOE = new EndNetherite.EndHoe(EndNetherite.INSTANCE, -13, 0, new Item.Settings().group(TOOLS).fireproof());
	public static final ArmorMaterial END_ARMOR_MATERIAL = new OverworldArmorMaterial();
